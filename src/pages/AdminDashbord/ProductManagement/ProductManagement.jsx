...
import { Products } from '../../FundraiseDashboard/data';
...
const ProductManagement = () => {
        ...
        return (
            <div className="actions-icons">
                ...
                <img
                    ...
                    onClick={() =>
                        navigate(`/products_management/${rowData.id}`, {
                            state: {
                                status: dataTab
                            }
                        })
    ...
    return (
        <React.Fragment>
            ...
            <div className="usermanage-main">
                <Card>
                    <div className="user-tabs-btn mb-4">
                        <Button className={dataTab === 'active' && 'activetbtn'} onClick={() => setDataTab('active')}>
                            Products
                        </Button>
                    ...
                    <div className="user-manag-chat">
                        <Row>
                            <Col xs={12} sm={6} lg={8} className="user-tabs-btn mb-2">
                            ...
                            <Col xs={12} sm={6} lg={4} className="user-tabs-btn spacer-tabs ">
            ...
            {showDialog && <ConfirmationBox show={showDialog} onClose={handleDialogClose} onConfirm={deleteCampaign} title={'Delete Product'} body={'Are you sure you want to delete this product?'} />}
        </React.Fragment>
    );
};
